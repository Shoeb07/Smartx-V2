...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "We design, build, and scale digital products for ambitious businesses. Custom software, apps, and digital transformation.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "SmartX Solutions",
      },
    ],
  },
  twitter: {
    ...
    title: "SmartX Solutions — Digital Innovation & Software Agency",
    description:
      "We design, build, and scale digital products for ambitious businesses.",
    images: ["/og-image.png"],
  },
  ...
  "@graph": [
    {
      ...
      url: siteUrl,
      description:
        "SmartX Solutions is a full-service digital innovation agency delivering custom software, web & mobile applications, and digital transformation services.",
      address: {
        "@type": "PostalAddress",
  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;1,9..40,300;1,9..40,400&display=swap"
          rel="stylesheet"
        />
        <script
